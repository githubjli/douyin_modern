...
class RemoteFeedRepository implements FeedRepository {
  ...
  FeedItem? _mapDramaEpisode(Map<String, dynamic> drama, Map<String, dynamic> episode) {
    ...
    return FeedItem(
      ...
      ownerId: _readString(drama['owner_id'] ?? drama['channel_id']),
      ownerAvatarUrl: _readString(drama['owner_avatar_url'] ?? drama['channel_avatar_url']),
      isFavorited: _readBool(drama['is_favorited']),
